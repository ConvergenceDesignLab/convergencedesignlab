...
/***/ (function(module, exports, __webpack_require__) {
	...
	function Loading(_ref) {
	  ...
	  return _react2.default.createElement(
	    "div",
	    { className: _indexModule2.default.container, style: { height: height } },
	    _react2.default.createElement("div", { className: _indexModule2.default.circle }),
	    _react2.default.createElement("div", { className: _indexModule2.default.circle }),
	    _react2.default.createElement("div", { className: _indexModule2.default.circle })
	  );
	}
...
/***/ (function(module, exports) {
	...
	module.exports = {"container":"src-components-loading----index-module---container---3CAtY","circle":"src-components-loading----index-module---circle---1fU7_","shrink":"src-components-loading----index-module---shrink---jeRxp"};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Work = function (_React$Component) {
	  ...
	  function Work() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = { projects: null }, _temp), _possibleConstructorReturn(_this, _ret);
	  }
	
	  Work.prototype.componentDidMount = function componentDidMount() {
	    var _this2 = this;
	
	    (0, _fetchWp.fetchProjects)().then(function (json) {
	  ...
	  Work.prototype.render = function render() {
	    ...
	    if (projects) {
	      projectGrid = projects.map(function (project) {
	        var id = project.id,
	            slug = project.slug,
	            acf = project.acf;
	        ...
	        return _react2.default.createElement(
	          "div",
	          { key: "project-" + id, className: _indexModule2.default.projectContainer },
	          _react2.default.createElement(
	            _gatsbyLink2.default,
	            { className: _indexModule2.default.projectLinkWrapper, to: "/work/" + slug + "/" },
	            _react2.default.createElement(
	              "figure",
	              { className: _indexModule2.default.projectFigure },
	              _react2.default.createElement("img", { className: _indexModule2.default.projectImage, src: (0, _lodash2.default)(acf, "banner.image.sizes.medium") }),
	              _react2.default.createElement(
	                "figcaption",
	                ...
	                _react2.default.createElement(
	                  "div",
	                  null,
	                  (0, _lodash2.default)(acf, "heading.subtitle")
	                )
	              )
	            )
	          )
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        projects ? _react2.default.createElement(
	          "div",
	          { className: _indexModule2.default.projectGrid },
	          projectGrid
	        ) : _react2.default.createElement(_loading2.default, { height: "65vh" })
	      ),
	      _react2.default.createElement(_callToAction2.default, { alternateColor: true })
	    );
	  };
...
/***/ (function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"projectLinkWrapper":"src-components-work----index-module---projectLinkWrapper---1uRow","title":"src-components-work----index-module---title---3hvQr","projectGrid":"src-components-work----index-module---projectGrid---1HilX","projectContainer":"src-components-work----index-module---projectContainer---1WuRU","projectFigure":"src-components-work----index-module---projectFigure---p3cF-","projectImage":"src-components-work----index-module---projectImage---12qqX","projectCaption":"src-components-work----index-module---projectCaption---CR6lY"};
...
//# sourceMappingURL=component---src-pages-work-js-96a3906643bca958a430.js.map